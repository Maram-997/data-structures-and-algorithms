...
const typeNum = (arr) => {
  // Solution code here...
  const newArr = arr.filter(element => element/element === 1)
  return newArr;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  const arr1 = arr.filter(word => word.includes('and') )
  return arr1;
};
...
const oddValues = (arr) => {
  // Solution code here...
  const new2 = arr.filter(num => num%2 == 1)
  return new2;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
const new3 = arr.filter(element =>{
  if( ! forbiddenValues.includes(element)) {return true}
} 
